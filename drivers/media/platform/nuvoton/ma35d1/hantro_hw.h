 ...
 */
enum hantro_enc_fmt {
	VC8K_VPU_ENC_FMT_YUV420P = 0,
	VC8K_VPU_ENC_FMT_YUV420SP = 1,
	VC8K_VPU_ENC_FMT_YUYV422 = 2,
	VC8K_VPU_ENC_FMT_UYVY422 = 3,
};

extern const struct hantro_variant ma35d1_vpu_variant;
